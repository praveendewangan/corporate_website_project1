...
<!-- Bootstrap Core CSS -->
<link href="<?php echo base_url();?>theme/backend/css/w3.css" rel="stylesheet"> 
...
<!-- chart -->
<script src="<?php echo base_url();?>theme/backend/js/Chart.js"></script>
<!-- //chart -->
...
<script src="<?php echo base_url();?>theme/backend/js/pie-chart.js" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					<link href="<?php echo base_url();?>theme/backend/css/owl.carousel.css" rel="stylesheet">
					<script src="<?php echo base_url();?>theme/backend/js/owl.carousel.js"></script>
						<script>
							$(document).ready(function() {
...
<body class="cbp-spmenu-push">
      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
			  ...
			  <?php for($i=0;$i<count($data['side']);$i++)
			  {
				  ?>
              <li class="treeview">
                <a href="<?php echo base_url().$data['side'][$i]->url;?>">
                <i class="<?php echo $data['side'][$i]->icon;?>"></i> <span><?php echo $data['side'][$i]->name;?></span>
                </a>
              </li>
			  <?php
			  }
             ...
             <!-- <li class="treeview">
              ...
              <li class="treeview">
                <a href="#">
                <i class="fa fa-edit"></i> <span>Contact</span>
                </a>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="<?php echo base_url();?>theme/backend/images/2.jpg" alt=""> </span> 
									<div class="user-name">
										<p>Admin Name</p>
    ...
    <script src="<?php echo base_url();?>theme/backend/js/Chart.bundle.js"></script>
    <script src="<?php echo base_url();?>theme/backend/js/utils.js"></script>
	...
	<!-- Classie --><!-- for toggle left push menu script -->
		<script src="<?php echo base_url();?>theme/backend/js/classie.js"></script>
		<script>
	...
	<script src="<?php echo base_url();?>theme/backend/js/SimpleChart.js"></script>
    <script>
        var graphdata1 = {
            linecolor: "#CCA300",
            title: "Monday",
