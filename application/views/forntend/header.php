...
<!-- head -->
<head>
<title>Apkishaadi Matrimonial</title>
<link href="<?php echo base_url();?>themes/frontend/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" /><!-- bootstrap-CSS -->
<link href="<?php echo base_url();?>themes/frontend/css/font-awesome.css" rel="stylesheet" type="text/css" media="all" /><!-- Fontawesome-CSS -->
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script type='text/javascript' src='<?php echo base_url();?>themes/frontend/js/jquery-2.2.3.min.js'></script>
<!-- Custom Theme files -->
<link href="<?php echo base_url();?>themes/frontend/css/menu.css" rel="stylesheet" type="text/css" media="all" /> <!-- menu style --> 
<!--theme-style-->
<link href="<?php echo base_url();?>themes/frontend/css/style.css" rel="stylesheet" type="text/css" media="all" />	
<!--//theme-style-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>themes/frontend/css/easy-responsive-tabs.css " />
<!--meta data-->
...
<!-- //nav smooth scroll -->			
<!-- Calendar -->
	<link rel="stylesheet" href="<?php echo base_url();?>themes/frontend/css/jquery-ui.css" />
...
<!-- //Calendar -->			
<link rel="stylesheet" href="<?php echo base_url();?>themes/frontend/css/intlTelInput.css">
</head>
<!-- //head -->
<!-- body -->
<body>
